...
import { 
  ...
  Info, BookOpen, Layers, Cpu, Eye, Fingerprint, BrainCircuit
} from 'lucide-react';

type View = 'home' | 'how-it-works' | 'about';
      ...
      <main className="flex-grow container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        {currentView === 'about' && (
          <div className="max-w-2xl w-full mx-auto animate-fade-in pt-8">
            <div className="bg-slate-800 rounded-3xl p-1 border border-slate-700 shadow-2xl overflow-hidden">
               <div className="bg-slate-900/50 p-8 md:p-12 text-center rounded-[22px]">
                  <div className="w-32 h-32 mx-auto bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full p-1 mb-8 shadow-xl shadow-blue-500/20">
                     <div className="w-full h-full bg-slate-800 rounded-full flex items-center justify-center overflow-hidden">
                        <ScanEye className="w-16 h-16 text-blue-400" />
                     </div>
                  </div>
                  
                  <h2 className="text-3xl font-bold text-white mb-3">Jagrat Mogaveera</h2>
                  ...
                  <div className="space-y-6 text-slate-300 leading-relaxed text-lg">
                     <p>
                       Check-Kar AI was conceptualized and built by <strong className="text-white">Jagrat Mogaveera</strong>, an Information Tech student currently studying at <strong className="text-white">TCSC</strong> (Thakur College of Science and Commerce).
                     </p>
                  ...
                  <div className="mt-10 pt-8 border-t border-slate-800 flex justify-center gap-6">
                     <a href="https://github.com/JKD-codes" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-800 rounded-full hover:bg-slate-700 text-slate-400 hover:text-white transition-colors">
                        <Github className="w-6 h-6" />
                     </a>
                     <a href="#" className="p-2 bg-slate-800 rounded-full hover:bg-slate-700 text-slate-400 hover:text-white transition-colors">
                        <BookOpen className="w-6 h-6" />
                     </a>
                     <a href="mailto:contact@example.com" className="p-2 bg-slate-800 rounded-full hover:bg-slate-700 text-slate-400 hover:text-white transition-colors">
